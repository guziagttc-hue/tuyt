            ...
            {!showEmailForm ? (
                <div className="space-y-3">
                    ...
                    <button 
                        ...
                        className="w-full flex items-center justify-center p-3 border border-red-500 rounded-lg text-sm font-semibold text-red-500 hover:bg-red-50 transition-colors"
                    >
                        <span className="flex-grow text-center">Demo Login</span>
                    </button>
                </div>
            ) : (
